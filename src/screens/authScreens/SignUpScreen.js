...
const initialValues = {phone_number:'',F_name:"",Last_name:"",password:"",email:'',username:''}
        ...
        <ScrollView keyboardShouldPersistTaps = "always">
                ...
                <Formik initialValues ={initialValues} onSubmit = {(values)=>{signUp(values)}}>
                  {(props)=>(
                        <View style ={styles.view2}>
                            <View>
                                <Text style ={styles.text2}>New on Smart Restaurant ?</Text>
                            </View>
                ...
                <View style ={styles.view19}>
                    <View style ={styles.view20}>
                        <Text style ={styles.text6}>Already have an account with Smart Restaurant ?</Text>
                    </View>

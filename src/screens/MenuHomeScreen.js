import { StyleSheet, Text, View , ImageBackground, ScrollView, Dimensions, TouchableHighlightComponent, TouchableOpacity} from 'react-native'
...
import MenuScreen from './MenuTabs/MenuScreen';
...
const MenuHomeScreen = ({navigation, route}) => {
    ...
    <View style = {styles.container}>
      ...
      <ScrollView>
        <View>
            ...
            <MenuHeader id = {id} navigation = {navigation}/>
            {productsData[id].discount && 
            <View style = { styles.view1}>
              <Text style= {styles.text1}> GET {productsData[id].discount} % OFF On Total</Text>
            </View>
            }

            <View style = {styles.view2}>
              <View style ={ styles.view3}>
                <Text style = {styles.text2}>{productsData[id].productName}</Text>
                  <View style = {styles.view4}>
                    ...
                    />
                   <Text style={styles.text4}> {productsData[id].averageReview}</Text> 
                   <Text style={styles.text5}> {productsData[id].numberofReview}</Text> 
              ...
              <View style= {styles.view5}>
                <Text style = {styles.text6}>Collect</Text>
                  <View style = {styles.view7}>
                    <Text style = {styles.text7}>{productsData[id].collectTime}</Text>
              ...
              <View style = {styles.view8}>
                <Text style = {styles.text6}>Delivery</Text>
                  ...
                  <Text style = {styles.text9}>{productsData[id].deliveryTime}</Text>
